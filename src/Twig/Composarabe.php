...
class Composarabe extends AbstractExtension
{
    private $em;
    ...
    public function getFunctions()
    {
        return array(
            ...
            new TwigFunction('compoarabes', array($this, 'getNotes')),
        );
    }
    ...
    public function getNotes(Eleve $eleve,Periode $periode, AnneeScolaire $annee)
    {
        ...
        return $this->em->getRepository(Notearabe::class)->compos($eleve->getId(),$periode->getId(), $annee->getId());
    }
}